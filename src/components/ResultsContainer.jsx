function ResultsContainer() {
  return (
    <div className="bg-slate900 text-white py-8 px-5 lg:rounded-bl-xxl">
      <h2 className="font-bold text-xl mb-4">Your results</h2>
      <p className="text-slate300 mb-5">
        Your results are shown below based on the information you provided. To
        adjust the results, edit the form and click &quot;calculate
        repayments&quot; again.
      </p>
      <div className="bg-slate950 py-4 px-3 rounded-lg border-t-4 border-lime">
